-- Fix telemetry overwrites and JSON parsing errors for anonymous users

-- Update the flush_telemetry function to safely cast JSON numeric values and ignore anonymous users
...
BEGIN
    ...
    IF v_user_id IS NULL THEN
        -- Silently return for anonymous telemetry instead of throwing 400 Bad Request
        RETURN;
    END IF;
