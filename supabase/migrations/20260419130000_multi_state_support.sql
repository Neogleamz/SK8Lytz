-- RESTORE MULTI-PICKER: Upgrade state_override to TEXT ARRAY
ALTER TABLE scraper_config 
ALTER COLUMN state_override TYPE TEXT[] 
USING CASE 
    WHEN state_override IS NULL THEN NULL
    ELSE ARRAY[state_override]
END;

-- Update the RPC to handle array matching
