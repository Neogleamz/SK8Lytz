# /product-alignment — Product Alignment Protocol

**Description:** Product Alignment Protocol — gut-check an idea against the Product Bible North Star.
**Persona:** 🎯 PM — Jordan
...
1. **Read the Compass**: Silently parse the `docs/SK8Lytz_App_Master_Reference.md` file (specifically Section 1: "Product Bible") to load the Core Philosophies and Anti-Goals into your active memory.
