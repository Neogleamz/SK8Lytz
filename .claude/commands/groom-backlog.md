# /groom-backlog — Autonomous Backlog Hygiene
...
1. **Information Gathering**: Read the contents of `docs/SK8Lytz_Bucket_List.md`.
...
4. **Relocation Protocol**: 
   - Use surgical edits to physically cut the entire multi-line block of lingering stale tasks out, and paste them down into the `❄️ ICEBOX` section.
