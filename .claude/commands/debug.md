...
4. **Instrumentation**: If the cause isn't obvious, inject highly specific `AppLogger.log`, `console.warn`, or `console.trace` calls within the component.
