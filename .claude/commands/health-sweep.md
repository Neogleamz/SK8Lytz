# /health-sweep — Pre-Release Health Sweep
...
When invoked via `/health-sweep` or as Phase 1 Step 1 of `/ship-it`, run all security and dependency health checks concurrently. This must pass before ANY release merge.

### Phase 1: Swarm Execution

Invoke 2 parallel sub-agents:
