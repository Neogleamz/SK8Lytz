...
**Swarm QA Protocol:** If the code changes span multiple disparate domains (e.g., both BLE Core and UI), invoke parallel sub-agents to evaluate the 5 cases concurrently for each distinct domain, rather than evaluating everything sequentially.
