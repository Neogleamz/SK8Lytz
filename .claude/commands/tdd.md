...
4. **Verification**: Run `npm run verify` (S7 — raw `jest` or `tsc` are banned) and confirm all tests pass and TypeScript compiles clean before asking the user for further instructions.
