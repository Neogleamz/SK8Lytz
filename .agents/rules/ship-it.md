...
6. **Push to Remote**: `git push origin <base-branch>`
7. **Clean Local**: `git branch -d <feature-branch>`
8. **Halt and Confirm**: Tell me the merge was successful and the local feature branch was cleaned up. Wait for my next command.
