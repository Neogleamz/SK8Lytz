...
4. **Cleanliness**: Perform one localized cleanup (boy-scout rule) in every file you modify, unless working on an isolated/surgical edit OR if the file is a core stability system (Dashboard, BLE, Groups). DO NOT boy-scout core monoliths!
