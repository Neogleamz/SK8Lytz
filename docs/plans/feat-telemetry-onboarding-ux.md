...
After the "Rock Solid" EULA, the user might feel overwhelmed by legal prose. We need to pivot to a **Casual, High-Trust Onboarding Screen** that explains *why* we need permissions in a skater-friendly way. 
...
- **Copy**: Focus on the *benefit* (e.g., "See your speed" instead of "Enable GPS").
...
- **Privacy Hero Section**: A prominent badge saying: *"No data sold. No trackers. Just SK8Lytz. We only use telemetry to make your lights smarter."*
