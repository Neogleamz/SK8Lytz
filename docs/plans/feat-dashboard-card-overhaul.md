...
2.  **Gradient Animation**: For the border flow, should the colors match the *active* pattern colors (dynamic) or stick to the SK8Lytz signature neon blue/pink (static premium)?
