...
export const SK8LYTZ_TEMPLATES: SK8LytzTemplate[] = [
  ...
  { id: 211, name: 'Rainbow Pulse',     icon: '💓', colorMode: 'GENERATIVE', requiresForeground: false, requiresBackground: false, supportsDirection: false, supportsSegment: false, tier: 1, group: 'Test' },
  ...
  { id: 218, name: 'Meteor Shower',     icon: '🌠', colorMode: 'FG_BG', requiresForeground: true, requiresBackground: true, supportsDirection: true, supportsSegment: false, tier: 1, group: 'Test' },
  ...
  { id: 225, name: 'Alternating Comet', icon: '🧬', colorMode: 'FG_BG', requiresForeground: true, requiresBackground: true, supportsDirection: true, supportsSegment: false, tier: 1, group: 'Test' },
  ...
  { id: 227, name: 'Rainbow Wave',      icon: '🏄', colorMode: 'GENERATIVE', requiresForeground: false, requiresBackground: false, supportsDirection: true, supportsSegment: false, tier: 1, group: 'Test' },
  { id: 228, name: 'Fire Flame',        icon: '🔥', colorMode: 'FG_ONLY', requiresForeground: true, requiresBackground: false, supportsDirection: true, supportsSegment: false, tier: 1, group: 'Test' },
  ...
  { id: 230, name: 'Ping-Pong Center',  icon: '🪀', colorMode: 'GENERATIVE', requiresForeground: false, requiresBackground: false, supportsDirection: false, supportsSegment: false, tier: 1, group: 'Test' },
  { id: 231, name: 'Stripe Scroll',     icon: '🦓', colorMode: 'FG_BG', requiresForeground: true, requiresBackground: true, supportsDirection: true, supportsSegment: false, tier: 1, group: 'Test' },
