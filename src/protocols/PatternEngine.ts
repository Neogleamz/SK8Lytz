...
export const SK8LYTZ_TEMPLATES: SK8LytzTemplate[] = [
  ...
  { id: 4 , name: 'Ping-Pong Fill',    icon: '↔️', colorMode: 'FG_BG', requiresForeground: true, requiresBackground: true, supportsDirection: false, supportsSegment: false, tier: 1, group: 'Wipe' },
  ...
  { id: 10, name: '3-Color Jump',      icon: '⚡', colorMode: 'GENERATIVE', requiresForeground: false, requiresBackground: false, supportsDirection: false, supportsSegment: false, tier: 1, group: 'Strobe' },
  ...
  { id: 13, name: 'Rainbow Jump',      icon: '⚡', colorMode: 'GENERATIVE', requiresForeground: false, requiresBackground: false, supportsDirection: false, supportsSegment: false, tier: 1, group: 'Strobe' },
  { id: 14, name: 'Irregular Strobe',  icon: '🌩️', colorMode: 'FG_BG', requiresForeground: true, requiresBackground: true, supportsDirection: false, supportsSegment: false, tier: 1, group: 'Strobe' },
  { id: 15, name: '3-Color Strobe',    icon: '✨', colorMode: 'GENERATIVE', requiresForeground: false, requiresBackground: false, supportsDirection: false, supportsSegment: false, tier: 1, group: 'Strobe' },
  { id: 16, name: 'Rainbow Strobe',    icon: '🎆', colorMode: 'GENERATIVE', requiresForeground: false, requiresBackground: false, supportsDirection: false, supportsSegment: false, tier: 1, group: 'Strobe' },
  ...
  { id: 22, name: 'Rainbow Wipe',      icon: '▶️', colorMode: 'GENERATIVE', requiresForeground: false, requiresBackground: false, supportsDirection: true, supportsSegment: false, tier: 1, group: 'Wipe' },
  { id: 23, name: 'Rainbow Sweep',     icon: '⏩', colorMode: 'GENERATIVE', requiresForeground: false, requiresBackground: false, supportsDirection: true, supportsSegment: false, tier: 1, group: 'Wipe' },
  ...
  { id: 26, name: 'Center-In Wipe',    icon: '🎯', colorMode: 'GENERATIVE', requiresForeground: false, requiresBackground: false, supportsDirection: false, supportsSegment: false, tier: 1, group: 'Wipe' },
  ...
  { id: 30, name: 'Ping-Pong Center',  icon: '🔀', colorMode: 'GENERATIVE', requiresForeground: false, requiresBackground: false, supportsDirection: false, supportsSegment: false, tier: 1, group: 'Wipe' },
