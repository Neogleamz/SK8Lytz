  ...
  public: {
    Tables: {
      ...
      cyclez: {
        ...
        Relationships: [
          {
            foreignKeyName: "cyclez_assigned_team_id_fkey"
      ...
      task_templates: {
        Row: {
          created_at: string | null
          default_status: Database["public"]["Enums"]["task_status"] | null
          description: string | null
      ...
      taskz: {
        ...
        Relationships: [
          {
            foreignKeyName: "taskz_assigned_team_id_fkey"
            columns: ["assigned_team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "taskz_cycle_id_fkey"
            columns: ["cycle_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "taskz_parent_task_id_fkey"
      ...
      user_lifetime_stats: {
        Row: {
          color_time_map: Json | null
          created_at: string | null
          engagement_counters: Json | null
          lifetime_top_speed_mph: number | null
          pattern_time_map: Json | null
          total_app_time_sec: number | null
          total_distance_meters: number | null
          total_street_sessions: number | null
          updated_at: string | null
          user_id: string
        }
        Insert: {
    ...
    Functions: {
      ...
      admin_add_hardware_blacklist: {
        Args: { p_mac_address: string; p_reason: string }
        Returns: undefined
      }
      admin_ban_user: {
      ...
      admin_get_global_telemetry: { Args: never; Returns: Json }
      admin_remove_hardware_blacklist: {
      ...
      flush_telemetry: { Args: { payload: Json }; Returns: undefined }
    ...
    Enums: {
      ...
      task_module: "inventory" | "sales" | "work_orders" | "cfo" | "general"
      task_status:
        | "Backlog"
        | "Todo"
        | "In Progress"
