...
class f {
    ...
    private final CompoundButton f1477a;

    /* renamed from: b  reason: collision with root package name */
    private ColorStateList f1478b = null;

    /* renamed from: c  reason: collision with root package name */
    private PorterDuff.Mode f1479c = null;
    ...
    public f(CompoundButton compoundButton) {
        this.f1477a = compoundButton;
    }

    void a() {
        Drawable a9 = androidx.core.widget.c.a(this.f1477a);
        if (a9 != null) {
            if (this.f1480d || this.f1481e) {
                Drawable mutate = androidx.core.graphics.drawable.a.r(a9).mutate();
                if (this.f1480d) {
                    androidx.core.graphics.drawable.a.o(mutate, this.f1478b);
                }
                if (this.f1481e) {
                    androidx.core.graphics.drawable.a.p(mutate, this.f1479c);
                }
                if (mutate.isStateful()) {
                    mutate.setState(this.f1477a.getDrawableState());
                }
                this.f1477a.setButtonDrawable(mutate);
            }
        }
    }
    ...
    public int b(int i8) {
        Drawable a9;
        return (Build.VERSION.SDK_INT >= 17 || (a9 = androidx.core.widget.c.a(this.f1477a)) == null) ? i8 : i8 + a9.getIntrinsicWidth();
    }
    ...
    */
    public void e(android.util.AttributeSet r10, int r11) {
        /*
            ...
            if (r10 == 0) goto L3a
            android.widget.CompoundButton r11 = r9.f1477a     // Catch: android.content.res.Resources.NotFoundException -> L3a java.lang.Throwable -> L84
        ...
        L3b:
            ...
            int r10 = r0.n(r10, r8)     // Catch: java.lang.Throwable -> L84
            if (r10 == 0) goto L58
            android.widget.CompoundButton r11 = r9.f1477a     // Catch: java.lang.Throwable -> L84
        ...
        L58:
            int r10 = g.j.Z0     // Catch: java.lang.Throwable -> L84
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L84
            if (r11 == 0) goto L69
            android.widget.CompoundButton r11 = r9.f1477a     // Catch: java.lang.Throwable -> L84
        ...
        L69:
            int r10 = g.j.f20005a1     // Catch: java.lang.Throwable -> L84
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L84
            if (r11 == 0) goto L80
            android.widget.CompoundButton r11 = r9.f1477a     // Catch: java.lang.Throwable -> L84
            r1 = -1
