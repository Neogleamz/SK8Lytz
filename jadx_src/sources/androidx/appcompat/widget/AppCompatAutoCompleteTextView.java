...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements androidx.core.view.a0, androidx.core.widget.o {

    /* renamed from: d  reason: collision with root package name */
    private static final int[] f1138d = {16843126};

    /* renamed from: a  reason: collision with root package name */
    private final d f1139a;

    /* renamed from: b  reason: collision with root package name */
    private final p f1140b;
    ...
    public AppCompatAutoCompleteTextView(Context context, AttributeSet attributeSet, int i8) {
        ...
        j0 v8 = j0.v(getContext(), attributeSet, f1138d, i8, 0);
        if (v8.s(0)) {
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1140b.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1140b.k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f1141c.d(j.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f1141c.a(keyListener));
    }
