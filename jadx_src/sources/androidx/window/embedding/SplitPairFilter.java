    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SplitPairFilter) {
            ...
            return p.a(this.primaryActivityName, splitPairFilter.primaryActivityName) && p.a(this.secondaryActivityName, splitPairFilter.secondaryActivityName) && p.a(this.secondaryActivityIntentAction, splitPairFilter.secondaryActivityIntentAction);
        }
        return false;
    }
    ...
    public final boolean matchesActivityIntentPair(Activity activity, Intent intent) {
        p.e(activity, "primaryActivity");
        p.e(intent, "secondaryActivityIntent");
