...
public abstract class NetworkConnectionInfo {
    ...
    public enum MobileSubtype {
        ...
        private static final SparseArray<MobileSubtype> C;
        ...
        public static MobileSubtype c(int i8) {
            return C.get(i8);
        }
    ...
    public enum NetworkType {
        ...
        private static final SparseArray<NetworkType> A;
        ...
        public static NetworkType c(int i8) {
            return A.get(i8);
        }
