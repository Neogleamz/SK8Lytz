...
public class OnedRecognitionOptions {
    ...
    public OnedRecognitionOptions setCodabarMinCodeLength(int i8) {
        this.codabarMinCodeLength = i8;
        return this;
    }

    public OnedRecognitionOptions setCodabarMinConsistentLines(int i8) {
        this.codabarMinConsistentLines = i8;
        return this;
    }

    public OnedRecognitionOptions setCode128MinCodeLength(int i8) {
        this.code128MinCodeLength = i8;
        return this;
    }

    public OnedRecognitionOptions setCode128MinConsistentLines(int i8) {
        this.code128MinConsistentLines = i8;
        return this;
    }

    public OnedRecognitionOptions setCode39MinCodeLength(int i8) {
        this.code39MinCodeLength = i8;
        return this;
    }

    public OnedRecognitionOptions setCode39MinConsistentLines(int i8) {
        this.code39MinConsistentLines = i8;
        return this;
    }

    public OnedRecognitionOptions setCode39UseCheckDigit(boolean z4) {
        this.code39UseCheckDigit = z4;
        return this;
    }

    public OnedRecognitionOptions setCode39UseExtendedMode(boolean z4) {
        this.code39UseExtendedMode = z4;
        return this;
    }

    public OnedRecognitionOptions setCode93MinCodeLength(int i8) {
        this.code93MinCodeLength = i8;
        return this;
    }

    public OnedRecognitionOptions setCode93MinConsistentLines(int i8) {
        this.code93MinConsistentLines = i8;
        return this;
    }

    public OnedRecognitionOptions setEan13UpcaMinConsistentLines(int i8) {
        this.ean13UpcaMinConsistentLines = i8;
        return this;
    }

    public OnedRecognitionOptions setEan8MinConsistentLines(int i8) {
        this.ean8MinConsistentLines = i8;
        return this;
    }

    public OnedRecognitionOptions setItfMinCodeLength(int i8) {
        this.itfMinCodeLength = i8;
        return this;
    }

    public OnedRecognitionOptions setItfMinConsistentLines(int i8) {
        this.itfMinConsistentLines = i8;
        return this;
    }

    public OnedRecognitionOptions setUpceMinConsistentLines(int i8) {
        this.upceMinConsistentLines = i8;
        return this;
    }
}
