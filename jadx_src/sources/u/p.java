...
public class p implements s0 {
    ...
    private static y0 b() {
        ...
        SurfaceConfig.ConfigType configType = SurfaceConfig.ConfigType.YUV;
        y0Var.a(SurfaceConfig.a(configType, SurfaceConfig.ConfigSize.VGA));
        y0Var.a(SurfaceConfig.a(configType, SurfaceConfig.ConfigSize.PREVIEW));
        y0Var.a(SurfaceConfig.a(configType, SurfaceConfig.ConfigSize.MAXIMUM));
        return y0Var;
    }

    private List<y0> d(int i8) {
        ArrayList arrayList = new ArrayList();
        if (i8 == 0) {
            arrayList.add(f22942a);
            arrayList.add(f22943b);
        }
        return arrayList;
    }

    private List<y0> e(String str) {
        ArrayList arrayList = new ArrayList();
        if (str.equals("1")) {
            arrayList.add(f22942a);
        }
    ...
    private static boolean h() {
        if ("samsung".equalsIgnoreCase(Build.BRAND)) {
            return f22944c.contains(Build.MODEL.toUpperCase(Locale.US));
        }
        return false;
    }

    public List<y0> c(String str, int i8) {
        return f() ? e(str) : h() ? d(i8) : Collections.emptyList();
    }
}
